...
components:
  ...
  # status-pill is the Driving/Riding role switch. See Components: Role-switch pill for the full
  # safety rationale behind the two fixed visual states below.
...
`[NOTE: several entries below link an HTML mockup for reference. Wherever a mockup is linked, this document is the authoritative contract and wins over the mockup if they ever conflict.]`
